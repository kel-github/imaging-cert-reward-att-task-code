...
% one of the gratings was rotated clockwise or counterclockwise
% the grating is followed by a mask. [insert extra info about luminance
% adjustments if using]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% clear all the tings
clear all
clear mex

% debug will skip through []
debug = 0;
...
% Reward scope.
sess.reward_base_low     = 5; % come back to this
sess.reward_bonus_low    = 5;
sess.reward_base         = 50;
sess.reward_bonus        = 50;
sess.reward_base_rt      = 0.85; % this will be randomly seeded rather than based on RT
sess.reward_max_bonus_rt = 0.35;

% block breakdown = 
% total = 1200 trials 200 x value
% block 1 = learn shape 1, 
